...
createConfirmationmbox();
	...
	if(!empty($_POST)){
		...
		if(isset($_POST['poster'])){
			...
			if($valid && isset($_SESSION['id']) && $ok==True){
	...
	<body>
				...
				<div class="col-8">
					<div class="topic__body">
						...
						<div class="topic__body__action__btn">
							<div>
								<form method="post" onsubmit="javascript:openulr('newurl.html')">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-8 col-md-6 col-12 pb-4">
                	...
                	<div class="comment mt-4 text-justify float-left"> <img src="https://i.imgur.com/yTFUilP.jpg" alt="" class="rounded-circle" width="40" height="40">
                 		<h4><?= $rtc['pseudo'] ?></h4>
						 <div class="topic__footer">
							<span>Le <?= date_format(date_create($rtc['date_creation']), 'd/m/Y à H:i') ?></span>
						<?php
							if($rtc['date_creation'] < $rtc['date_modification']){
						?>
							<span>Modifié le <?= date_format(date_create($rtc['date_modification']), 'd/m/Y à H:i') ?></span>
							<?php	
							}
							?>
						<p><?= nl2br($rtc['contenu']) ?></p>
                	</div>
					<?php
						...
						<div class="topic__body__action__btn">
							...
							<div>
								<a href="./site2/_forum/editer-commentaire.php?id=<?= $rtc['id'] ?>" class="topic__action__btn">
